...
/**
 * ClassName:HttpClientUtilsGX
 * GX:李王柱
 */
public class HttpClientUtilsGX {
     ...
     * 设置连接超时时间，单位毫秒。
     */
    private static final Integer CONNECT_TIMEOUT = 35000;

    /**
     * 请求获取数据的超时时间(即响应时间)，单位毫秒。
     */
    private static final Integer SOCKET_TIMEOUT = 35000;
